define(['angularAMD'], function (control) {
    control.directive('pnTextboxNumber', function () {
      return {
            ...
            template: '<input type="text"  ng-trim="false" class="form-control mousetrap LeftToRightTextBox"/> ',
            link: function ($scope, $elem, $attrs, ngModelCtrl) {
                ...
                ngModelCtrl.$render = function () {
                    var tf = angular.isUndefined(ngModelCtrl.$viewValue) ? "" : ngModelCtrl.$viewValue;
