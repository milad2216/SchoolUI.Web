...
(function($, undefined) {	
    ...
    var calendar = {
        ...
        setTime: function (date, time) {
			...
			if(before === after && time == MS_PER_DAY)
                ...
                return view({
                    ...
                    build: function(date) {
                        ...
                        if (date < firstDayOfMonth) {
                            var sd = (new DATE(date.getTime())).setHours(0, 0, 0, 0, 0),
                                md = (new DATE(firstDayOfMonth.getTime())).setHours(0, 0, 0, 0, 0)
                            ;
                            if (sd !== md)
                        ...
                        if (date > lastDayOfMonth) {
                            //var sd = (new DATE(date.getTime())).setHours(0, 0, 0, 0, 0),
                            //    ld = (new DATE(lastDayOfMonth.getTime())).setHours(0, 0, 0, 0, 0)
                            //;
                            //if (sd !== ld)
                                cssClass.push(OTHERMONTH);
                        }
