(function ($) {
    $.fn.ribbon = function (id) {
        ...
        that.init = function (id) {
            ...
            ribObj = $('#' + id);
            //ribObj.find('.ribbon-container').after('<div id="ribbon-tab-header-strip"></div>');
            ...
            ribObj.find('.ribbon-tab').each(function (index) {
                ...
                var systemTotalCode = title.data("systemtotalcode") || 0; // this line added
                var systemkey = title.data("systemkey") || 0; // this line added
                var isBackstage = $(this).hasClass('file');
                header.append('<div id="ribbon-tab-header-' + index + '" class="ribbon-tab-header" data-systemtotalcode="' + systemTotalCode + '" data-systemkey="' + systemkey + '"></div>'); // this line changed
                var thisTabHeader = header.find('#ribbon-tab-header-' + index);
                thisTabHeader.append(title.removeAttr("data-systemkey").removeAttr("data-systemtotalcode"));
                if (isBackstage) {
